...
function App() {
  ...
  },
  {
    ...
    function displayCars(e){
       filteredCarData = carData.filter((ele,index)=>{
        if(carName===''){
          return true;
        }
        return ele.name.toLowerCase().includes(carName.toLowerCase());
       });
    ...
    return <>
        <Header />
        <input type="text" value={carName} onChange={handleChange} />
        <button onClick={displayCars}>submit</button>
        <div id="carcardcont">
            {
